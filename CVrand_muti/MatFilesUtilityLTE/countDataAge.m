function [dataAgeTimestampMatrix,dataAgeCounter] = countDataAge(stationManagement,iPhyRaw,timeManagement,IDvehicleTX,indexVehicleTX,BRid,NbeaconsF,awarenessID,errorMatrix,elapsedTime,dataAgeTimestampMatrix,dataAgeCounter,delayResolution,appParams)
