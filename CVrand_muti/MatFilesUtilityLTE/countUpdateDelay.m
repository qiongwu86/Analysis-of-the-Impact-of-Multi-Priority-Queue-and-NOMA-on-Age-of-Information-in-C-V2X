function [updateTimeMatrix,updateDelayCounter] = countUpdateDelay(stationManagement,iPhyRaw,IDvehicleTX,indexVehicleTX,BRid,NbeaconsF,awarenessID,errorMatrix,elapsedTime,updateTimeMatrix,updateDelayCounter,delayResolution,enableUpdateDelayHD)
