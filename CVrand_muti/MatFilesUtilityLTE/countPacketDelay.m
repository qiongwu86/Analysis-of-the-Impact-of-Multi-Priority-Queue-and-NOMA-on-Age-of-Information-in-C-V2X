function packetDelayCounter = countPacketDelay(stationManagement,iPhyRaw,IDvehicleTX,subframeNow,subframeLastPacket,NcorrectTX,packetDelayCounter,delayResolution)
...
for i = 1:Ntx
    ...
    if subframeLastPacket(IDvehicleTX(i))>0
        packetDelay = subframeNow - min(subframeLastPacket(IDvehicleTX(i),:));
