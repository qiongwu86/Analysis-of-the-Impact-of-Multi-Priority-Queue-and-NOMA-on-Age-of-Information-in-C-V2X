...
%%%%%%%%%%%替换station.A
% stationManagement.RRI(needReselectionCounterRestart)= (stationManagement.B(needReselectionCounterRestart))'stationManagement.RRI(needReselectionCounterRestart)= (stationManagement.B(needReselectionCounterRestart))';stationManagement.RRI(needReselectionCounterRestart)= (stationManagement.B(needReselectionCounterRestart))';stationManagement.RRI(needReselectionCounterRestart)= (stationManagement.B(needReselectionCounterRestart))';;
